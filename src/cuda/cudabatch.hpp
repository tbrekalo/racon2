...
class CUDABatchProcessor {
 ...
 protected:
   ...
   */
  CUDABatchProcessor(uint32_t max_window_depth, uint32_t device,
                     size_t avail_mem, int8_t gap, int8_t mismatch,
   ...
   *
   */
  void convertPhredQualityToWeights(const char* qual, uint32_t qual_length,
